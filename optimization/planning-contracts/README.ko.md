...
| 책임 | 사용 기능 |
|---|---|
| 버전 기준 | `bluetape4k-dependencies:2.1.0-SNAPSHOT` |
...
`bluetape4k-dependencies:2.1.0-SNAPSHOT` 해석 결과는 JetBrains Exposed `1.4.0`,
Bluetape Exposed `2.1.0-SNAPSHOT`입니다. 하위 artifact 버전은 root BOM 버전과
별도로 관리됩니다.
