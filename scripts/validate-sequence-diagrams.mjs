...
if (failures.length > 0) {
  console.error(JSON.stringify({ checked: files.length, failures: failures.length, sample: failures.slice(0, 40) }, null, 2));
  process.exit(1);
}

console.log(JSON.stringify({ checked: files.length, failures: 0 }, null, 2));
