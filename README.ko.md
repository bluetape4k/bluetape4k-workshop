...
| Basic | [`kotlin-text-processing`](kotlin/text-processing/) | `text-search`, `lingua`, `text-korean`, `text-japanese`, `coroutines` | In-memory | 다국어 텍스트 정규화, 시작 단계 dictionary readiness, 동기/코루틴 검색 색인, 원문 span highlighting |
