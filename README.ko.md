...
| Basic | [`kotlin-text-processing`](kotlin/text-processing/) | `text-search`, `lingua`, `text-korean`, `text-japanese` | In-memory | 다국어 텍스트 정규화, 언어 감지, 검색 색인, 원문 span highlighting |
