...
| Advanced | [`aws-sqs-sns-coroutines`](aws/sqs-sns-coroutines/) | `aws`, `micrometer`, `coroutines` | Local adapters | SNS publish plus SQS consume with ack, retry, dead-letter reports, and cancellation-safe coroutines |
