...
| Basic | [`kotlin-text-processing`](kotlin/text-processing/) | `text-search`, `lingua`, `text-korean`, `text-japanese`, `coroutines` | In-memory | Multilingual text normalization, startup dictionary readiness, sync/coroutine search indexing, and source-span highlighting |
