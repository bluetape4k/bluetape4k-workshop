...
| Advanced | [`aws-sqs-sns-coroutines`](aws/sqs-sns-coroutines/) | `aws`, `micrometer`, `coroutines`, `testcontainers` | Local adapters + Floci | SNS publish/PublishBatch plus SQS consume with per-entry outcomes, ack, retry, dead-letter reports, and cancellation-safe coroutines |
