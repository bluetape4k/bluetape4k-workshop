...
plugins {
    ...
    // for JMolecules
    id("net.bytebuddy.byte-buddy-gradle-plugin") version "1.18.11" apply false
}
...
fun registerHighContentionSuiteTask(
    taskName: String,
    suiteMode: String,
) {
...
registerHighContentionSuiteTask("highContentionCi", "ci-correctness")
registerHighContentionSuiteTask("highContentionLocalReference", "local-reference")
