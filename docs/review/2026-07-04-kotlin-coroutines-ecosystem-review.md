...
- 모듈: `:kotlin-coroutines`
- 브랜치: `refactor/kotlin-coroutines-ecosystem-patterns`
- 리뷰 유형: 7-tier 코드 리뷰와 bluetape4k 생태계 사용 점검
- 초점: coroutine timing 예제를 cancellation-friendly하게 유지하고 Spring scope helper의 null assertion을 명확한 assertion으로 바꿨는지 확인했다.
