...
- 모듈: `:image-processing-ocr-api`
- 브랜치: `refactor/image-processing-ocr-api-ecosystem-patterns`
- 리뷰 유형: 7-tier 코드 리뷰와 bluetape4k 생태계 사용 점검
- 초점: OCR configuration과 decoded-pixel validation을 helper API와 맞추면서 upload error message 계약을 보존했는지 검토했다.
