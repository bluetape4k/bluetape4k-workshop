...
abstract class AbstractSocialNetworkSuspendTest {
    ...
    @Test
    fun `findWeightedConnectionPath prefers lower cumulative strength over fewer hops`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
        val bob = service.addPerson("bob", "Bob Jones")
    ...
    @Test
    fun `findWeightedConnectionPath enforces inclusive maxDepth without returning a partial path`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
        val bob = service.addPerson("bob", "Bob Jones")
        val carol = service.addPerson("carol", "Carol Park")
        val dave = service.addPerson("dave", "Dave Kim")
    ...
    @Test
    fun `findWeightedConnectionPath allows a zero-depth vertex-only path`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
    ...
    @Test
    fun `findWeightedConnectionPath returns null after maxVisited is exceeded`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
        val bob = service.addPerson("bob", "Bob Jones")
        val carol = service.addPerson("carol", "Carol Park")
        val dave = service.addPerson("dave", "Dave Kim")
    ...
    @Test
    fun `findWeightedConnectionPath exposes missing weight policies`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
        val bob = service.addPerson("bob", "Bob Jones")
        val carol = service.addPerson("carol", "Carol Park")
    ...
    @Test
    fun `findWeightedConnectionPath rejects non-positive non-finite and non-numeric weights`() = runSuspendIO {
    ...
    @Test
    fun `findWeightedConnectionPath honors direction`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
        val bob = service.addPerson("bob", "Bob Jones")
        addKnows(alice, bob, "1")
    ...
    @Test
    fun `findWeightedConnectionPath is deterministic for equal-cost paths`() = runSuspendIO {
        val alice = service.addPerson("alice", "Alice Smith")
        val bob = service.addPerson("bob", "Bob Jones")
        val carol = service.addPerson("carol", "Carol Park")
        val dave = service.addPerson("dave", "Dave Kim")
    ...
    @Test
    fun `findWeightedConnectionPath matches the backend PathOptions result`() = runSuspendIO {
        val seed = seedSocialNetwork(service)
        val options = PathOptions(
            edgeLabel = KnowsLabel.label,
            maxDepth = SocialNetworkSuspendService.MAX_TRAVERSAL_DEPTH,
    ...
    private suspend fun addKnows(from: GraphVertex, to: GraphVertex, weight: Any?) {
