...
/**
 * [RecommendationSuspendService] tests backed by TinkerGraph (in-memory, no Docker required).
 *
 * All tests from [AbstractRecommendationSuspendTest] run against an in-process
