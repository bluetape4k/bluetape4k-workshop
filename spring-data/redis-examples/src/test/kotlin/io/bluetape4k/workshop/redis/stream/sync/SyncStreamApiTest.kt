...
class SyncStreamApiTest @Autowired constructor(
    ...
    fun `send to stream by XADD, and read record from stream by XREAD`() {
        ...
        // stream 시작 지점부터 XREAD 합니다. Kafka 의 earliest 전략과 같습니다.
        val fromStart =
        ...
        // fiexedId2 이후부터 XREAD 를 재개합니다. Kafka 의 latest 전략과 같습니다.
        val fromOffset =
    ...
    fun `stream listener 를 통한 연속적 읽기`() {
        ...
        // XREAD BLOCK 으로 StreamListener 를 등록합니다.
