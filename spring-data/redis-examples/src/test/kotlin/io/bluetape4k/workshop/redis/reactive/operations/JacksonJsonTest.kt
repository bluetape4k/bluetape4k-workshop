...
import io.bluetape4k.workshop.redis.reactive.model.EmailAddress
...
class JacksonJsonTest @Autowired constructor(
     ...
     *
     * @see [io.bluetape4k.workshop.redis.reactive.ReactiveRedisConfiguration.reactiveJsonPersonRedisTemplate]
     */
    @Test
     ...
     *
     * @see [io.bluetape4k.workshop.redis.reactive.RedisTestConfiguration.reactiveJsonObjectRedisTemplate]
     */
    @Test
    fun `write and read person as object`() = runSuspendTest {
        ...
        value shouldBeEqualTo """{"@class":"io.bluetape4k.workshop.redis.reactive.model.Person","firstname":"Homer","lastname":"Simpson"}"""
    ...
    fun `write and read email object`() = runSuspendTest {
        ...
        value shouldBeEqualTo """{"@class":"io.bluetape4k.workshop.redis.reactive.model.EmailAddress","address":"homer@the-simpson.com"}"""
