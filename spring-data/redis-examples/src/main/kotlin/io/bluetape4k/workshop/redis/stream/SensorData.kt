...
class SensorData {
    ...
    companion object: KLoggingChannel() {
        ...
        // 
        internal val RECORD_1234_0: StringRecord = create("5-12", "18", "r2d2").withId(RecordId.of("1234-0"))
        internal val RECORD_1234_1: StringRecord = create("5-13", "9", "c3o0").withId(RecordId.of("1234-1"))
        internal val RECORD_1235_0: StringRecord = create("5-13", "18.2", "bb8").withId(RecordId.of("1235-0"))
