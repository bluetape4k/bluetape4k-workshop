...
class ProfileImageModerationPolicyProviderTest {
    ...
    @ValueSource(strings = ["nazi-symbol.jpg", "rising-sun-avatar.jpg", "hate-text-profile.jpg", "reject.jpg"])
    ...
    private fun request(filename: String): ModerationRequest = ModerationRequest(
        ...
        originalKey = ImageObjectKey.of("profile-images/user-1/upload-a/private/original", filename),
    )
}
