...
![Spring WebFlux with Coroutines and Virtual Thread 아키텍처 다이어그램](../../docs/images/readme-diagrams/virtualthreads-spring-webflux-diagram-01.png)

## 흐름 다이어그램

1. `virtualthreads-spring-webflux` 예제에 필요한 로컬 런타임을 준비합니다.
