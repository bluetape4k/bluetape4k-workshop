...
All notable changes to `bluetape4k-workshop` are documented here.

The format follows [Keep a Changelog](https://keepachangelog.com/en/1.0.0/).
This repository contains runnable workshop and example applications.
...
- Spring Boot 4.0.6, AspectJ, Logback override, and protobuf `protoc` compatibility issues ([PR #17](https://github.com/bluetape4k/bluetape4k-workshop/pull/17)).
- GraalVM Native 1.1.0 and `spring-context` version reference issues ([PR #18](https://github.com/bluetape4k/bluetape4k-workshop/pull/18)).
