...
class ObservationAspectConfig {
    ...
    fun observedAspect(observationRegistry: ObservationRegistry): ObservedAspect {
        return ObservedAspect(observationRegistry, this::skipControllers)
    }

    /**
     * `@RestController` 또는 `@Controller` 를 가진 클래스는 [ObservedAspect]를 적용하지 않습니다.
     */
