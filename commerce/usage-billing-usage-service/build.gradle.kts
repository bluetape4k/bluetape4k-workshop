...
springBoot {
    mainClass.set("io.bluetape4k.workshop.commerce.usagebilling.usage.UsageServiceApplicationKt")
}
...
tasks.register<Test>("integrationTest") {
    description = "Runs PostgreSQL-backed Usage service integration tests."
    group = "verification"
