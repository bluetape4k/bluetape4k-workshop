...
springBoot {
    mainClass.set("io.bluetape4k.workshop.commerce.usagebilling.billing.BillingServiceApplicationKt")
}
...
tasks.register<Test>("integrationTest") {
    description = "Runs PostgreSQL-backed Billing service integration tests."
    group = "verification"
