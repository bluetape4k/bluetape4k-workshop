...
springBoot {
    mainClass.set("io.bluetape4k.workshop.commerce.usagebilling.query.QueryServiceApplicationKt")
}
...
tasks.register<Test>("integrationTest") {
    description = "Runs PostgreSQL-backed Query service integration tests."
    group = "verification"
