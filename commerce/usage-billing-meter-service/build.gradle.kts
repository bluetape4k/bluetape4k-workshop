...
springBoot {
    mainClass.set("io.bluetape4k.workshop.commerce.usagebilling.meter.MeterServiceApplicationKt")
}
...
tasks.register<Test>("integrationTest") {
    description = "Runs PostgreSQL-backed Meter service integration tests."
    group = "verification"
