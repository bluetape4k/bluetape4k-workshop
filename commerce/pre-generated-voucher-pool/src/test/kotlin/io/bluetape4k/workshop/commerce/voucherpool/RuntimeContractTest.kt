...
internal class RuntimeContractTest {
    ...
    fun `runtime uses Java 25 virtual threads and excludes the JDK21 provider`() {
        ...
        properties.getProperty("workshop.voucher-pool.startup-initializer-enabled") shouldBeEqualTo "true"
        properties.getProperty("workshop.voucher-pool.worker-dispatcher-enabled") shouldBeEqualTo "true"
        properties.getProperty("workshop.voucher-pool.database.foreground.capacity") shouldBeEqualTo "11"
        properties.getProperty("workshop.voucher-pool.database.foreground.permit-wait") shouldBeEqualTo "200ms"
