...
internal class CapacityResourceRepository :
    ...
    override fun ResultRow.toEntity() = CapacityResourceRecord(
    ...
    fun create(code: String, capacity: Int, policyVersion: Long): CapacityResourceRecord {
    ...
    fun tryOccupy(id: Long, expectedRevision: Long): Boolean {
    ...
    fun release(id: Long, expectedRevision: Long): Boolean = auditedUpdateAll({
        (table.id eq id) and
            (table.revision eq expectedRevision) and
