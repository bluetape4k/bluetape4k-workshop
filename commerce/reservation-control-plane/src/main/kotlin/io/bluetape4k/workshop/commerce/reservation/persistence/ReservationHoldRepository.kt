...
internal class ReservationHoldRepository : LongAuditableJdbcRepository<ReservationHoldRecord, ReservationHoldTable> {
    ...
    override fun ResultRow.toEntity() = ReservationHoldRecord(
    ...
    fun create(resourceId: Long, ownerDigest: String, policyVersion: Long, expiresAt: Instant): ReservationHoldRecord {
    ...
    fun expiredForResource(resourceId: Long, now: Instant): List<ReservationHoldRecord> = table.selectAll()
        .where {
