...
internal class ReservationCredentialService(secret: String) {
    ...
    fun idempotencyDigest(tenant: String, operation: String, rawKey: String): String =
        digest("http-idempotency", "$tenant\u0000$operation\u0000$rawKey")

    fun matchesOwner(rawOwner: String, expectedDigest: String): Boolean {
    ...
    fun matchesOperator(rawKey: String, expectedDigest: String): Boolean {
