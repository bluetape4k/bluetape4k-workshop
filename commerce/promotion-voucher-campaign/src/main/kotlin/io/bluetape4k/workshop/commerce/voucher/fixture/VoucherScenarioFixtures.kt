...
internal class VoucherScenarioFixtures {
    ...
    fun configure(
        ...
        val definition = BY_SLUG[slug] ?: throw IllegalArgumentException("unsupported fixture scenario")
    ...
    fun consumeRiskSignal(
        tenantId: String,
        principalRef: String,
    ): RiskSignal? = configured.remove(FixtureSubject(tenantId, principalRef))?.riskSignal
    ...
    companion object {
        ...
        private val DEFINITIONS =
            listOf(
                ...
                scenario("allocation-review", "Allocation enters operator review", "ACTIVE", "PENDING_REVIEW", true, "ALLOCATION_REVIEW_OPENED", RiskSignal.REVIEW),
                scenario("redemption-review", "Redemption enters operator review", "ACTIVE", "PENDING_REVIEW", true, "REDEMPTION_REVIEW_OPENED", RiskSignal.REVIEW),
                ...
                scenario("redis-outage", "Redis loss falls back to PostgreSQL", "ACTIVE", "ALLOCATED", false, "REDIS_DEGRADED", RiskSignal.UNKNOWN),
                scenario("bloom-false-positive", "Bloom positive opens review without terminal rejection", "ACTIVE", "PENDING_REVIEW", true, "BLOOM_REVIEW_OPENED", RiskSignal.REVIEW),
